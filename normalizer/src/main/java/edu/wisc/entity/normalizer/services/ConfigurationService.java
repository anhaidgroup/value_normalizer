...
public class ConfigurationService {
    ...
    public static String CDRIVE_DOWNLOAD_URL="http://api.cdrive.columbusecosystem.com/download/?file_name=";
    public static String CDRIVE_UPLOAD_URL="http://api.cdrive.columbusecosystem.com/upload/";
